        ...
        <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6 mt-12">
                <div class="benefit-card p-6 text-center">
                    <div class="text-3xl mb-4 text-indigo-600"><i class="fas fa-star"></i></div>
                ...
                <div class="benefit-card p-6 text-center">
                    <div class="text-3xl mb-4 text-indigo-600"><i class="fas fa-users"></i></div>
                ...
                <div class="benefit-card p-6 text-center">
                    <div class="text-3xl mb-4 text-indigo-600"><i class="fas fa-handshake"></i></div>
            ...
            <div class="bg-white rounded-3xl shadow-xl shadow-slate-200 border border-slate-100 overflow-hidden">
                <form class="p-8 sm:p-12 space-y-8" action="{{ route('register.provider.post') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
                            <div>
                                ...
                                <input id="name" name="name" type="text" required value="{{ old('name') }}" class="w-full px-4 py-3 rounded-xl border-2 border-slate-200 hover:border-indigo-300 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-100 outline-none transition-all" placeholder="Jean Dupont">
                            </div>
                            <div>
                                ...
                                <input id="email" name="email" type="email" required value="{{ old('email') }}" class="w-full px-4 py-3 rounded-xl border-2 border-slate-200 hover:border-indigo-300 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-100 outline-none transition-all" placeholder="contact@entreprise.tg">
                            </div>
                        </div>
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6 mt-4">
                            <div>
                                ...
                                <input id="cni_number" name="cni_number" type="text" required value="{{ old('cni_number') }}" class="w-full px-4 py-3 rounded-xl border-2 border-slate-200 hover:border-indigo-300 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-100 outline-none transition-all" placeholder="0123456789">
                            </div>
                            <div>
                                ...
                                <input id="years_of_experience" name="years_of_experience" type="number" required min="0" max="70" value="{{ old('years_of_experience', 0) }}" class="w-full px-4 py-3 rounded-xl border-2 border-slate-200 hover:border-indigo-300 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-100 outline-none transition-all">
                            </div>
                        </div>
                        <div class="mt-4 p-4 bg-indigo-50 rounded-xl border border-indigo-100">
                            <p class="text-xs font-bold text-indigo-900 mb-3">PIÈCES D'IDENTITÉ REQUISES</p>
                    ...
                    <div class="form-group border-t pt-8">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
                            <div>
                                ...
                                <input id="business_name" name="business_name" type="text" required value="{{ old('business_name') }}" class="w-full px-4 py-3 rounded-xl border-2 border-slate-200 hover:border-indigo-300 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-100 outline-none transition-all" placeholder="Ex: Lumina Events">
                            </div>
                            <div>
                                <label for="phone" class="block text-sm font-bold text-slate-700 mb-2">Téléphone (WhatsApp) <span class="text-rose-500">*</span></label>
                                <input id="phone" name="phone" type="tel" required value="{{ old('phone') }}" class="w-full px-4 py-3 rounded-xl border-2 border-slate-200 hover:border-indigo-300 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-100 outline-none transition-all">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6 mt-4">
                            <div>
                                ...
                                <select id="service_kind" name="service_kind" required class="w-full px-4 py-3 rounded-xl border-2 border-slate-200 hover:border-indigo-300 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-100 outline-none transition-all appearance-none bg-white">
                            ...
                            <div id="category_container" class="{{ old('service_kind') ? '' : 'hidden' }}">
                                ...
                                <select id="category_ids" name="category_ids[]" multiple required class="w-full px-4 py-3 rounded-xl border-2 border-slate-200 hover:border-indigo-300 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-100 outline-none transition-all appearance-none bg-white">
                                    @php
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6 mt-4">
                            <div>
                                ...
                                <select id="city_id" name="city_id" required class="w-full px-4 py-3 rounded-xl border-2 border-slate-200 hover:border-indigo-300 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-100 outline-none transition-all appearance-none bg-white">
                    ...
                    <div class="form-group border-t pt-8">
                        ...
                        <div class="bg-slate-50 border border-slate-200 p-6 rounded-2xl">
                            <label class="flex items-center gap-4 cursor-pointer">
                                <div class="relative">
                                    <input type="checkbox" id="is_company" name="is_company" value="1" {{ old('is_company') ? 'checked' : '' }} class="w-6 h-6 text-indigo-600 rounded-lg border-2 border-slate-300 focus:ring-2 focus:ring-indigo-500 cursor-pointer">
                                </div>
                                <div>
                    ...
                    <div class="border-t pt-8">
                        ...
                        <p class="text-center text-xs text-slate-500 mt-4">
                            En vous inscrivant, vous acceptez nos <a href="{{ route('legal.cgu') }}" class="font-bold text-indigo-600 hover:text-indigo-500">conditions générales</a> et notre <a href="{{ route('legal.privacy') }}" class="font-bold text-indigo-600 hover:text-indigo-500">politique de confidentialité</a>
                        </p>
                    </div>
                </form>
                ...
                <div class="bg-slate-50 px-8 sm:px-12 py-8 border-t border-slate-200">
                    <p class="text-center text-slate-600">
                        Déjà inscrit? <a href="{{ route('filament.provider.auth.login') }}" class="font-bold text-indigo-600 hover:text-indigo-700 transition-colors">Se connecter à l'espace pro</a>
                    </p>
                </div>
            </div>
        </div>
